...
export default function Dashboard({ props }) {
  return (
    <>
      ...
      <nav
        id="sidenav-8"
        class="z-[1035] h-full w-60 overflow-hidden bg-white shadow-[0_4px_12px_0_rgba(0,0,0,0.07),_0_2px_4px_rgba(0,0,0,0.05)] data-[te-sidenav-hidden='false']:translate-x-0 dark:bg-zinc-800"
      >
        <a
          ...
          <svg class="branding" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 40" width="120" height="40">
            <title>Logo</title>
