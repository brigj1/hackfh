...
export function DonationEventAdd() {
  ...
  const handleSubmit = (e) => {
    ...
    (async function () {
      const response = await fetch('http://localhost:3000/partner/donation/add', configObj);
...
export function DonationItemAdd() {
  ...
  useEffect(() => {
    async function fetchItems() {
      // fetch('/items');
      const response = await fetch('http://localhost:3000/partner/item/list/api');
  ...
  const handleSubmit = (e) => {
    ...
    (async function () {
      const response = await fetch('http://localhost:3000/partner/donation/add/api', configObj);
